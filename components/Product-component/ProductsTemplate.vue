            ...
            <div class="goods-page">
                ...
                <div class="goods-section-wrapper">  
                    <div class="goods-section">
                        <div class="goods-section-items" v-for="category in categories" :key="category.id">
                            <div class="goods-picture">
                                <img :src="`http://localhost:1337${category.attributes.picture.data[0].attributes.url}`">
                            </div>
                            <div class="goods-description">
                                <p> {{ category.attributes.name }} </p>
                            </div>
                            <div class="flex-row goods-existence">
                                <div class="flex-row" v-if="category.attributes.available">
    ...
    export default {
        ...
        computed: {
            categories() {
                ...
                const productPage = this.$store.state.service.categoryProducts;
                const newProductPage = productPage.slice(0,20)
